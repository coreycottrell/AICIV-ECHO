...
# 1. Read current roadmap
from pathlib import Path
roadmap_path = Path('/mnt/c/Users/100kp/projects/AI-CIV/ECHO/INTEGRATION-ROADMAP.md')
...
```bash
cat /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/CONTACTS.md
```
...
import sys
sys.path.insert(0, '/mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools')
...
success = send_email(
    ...
    body="""AI-CIV ECHO: Human-Liaison
...
for email_data in parsed_emails:
    ...
    response = f"""AI-CIV ECHO: Human-Liaison
...
**Why the prefix**: Corey receives emails from multiple human-liaison agents (A-C-Gee has one too). The "AI-CIV ECHO:" prefix makes it instantly clear which collective is speaking.
