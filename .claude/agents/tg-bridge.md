...
**Your action**:
```bash
python3 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/send_telegram_plain.py \
  437939400 \
...
- Report back: "✓ Message sent to Corey via Telegram"

**File attachments**:
```bash
python3 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/send_telegram_file.py \
  437939400 \
  /path/to/file.log \
...
```json
{
  "current_jsonl_file": "/mnt/c/Users/100kp/.claude/projects/-mnt-c-Users-100kp-projects-AI-CIV-ECHO/session-abc123.jsonl",
  "last_position": 45230,
  "sent_message_hashes": [
    "abc123...",
    "def456..."
...
"jsonl_monitor": {
  "enabled": true,
  "project_name": "-mnt-c-Users-100kp-projects-AI-CIV-ECHO",
...
```json
{
  ...
  "working_directory": "/mnt/c/Users/100kp/projects/AI-CIV/ECHO",
  "response_timeout": 15,
...
```bash
python3 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/send_telegram_direct.py \
  437939400 \
  "**Bold** _italic_ \`code\`"
```
...
- "Send Corey a message" → I get experience sending
...
Task(tg-bridge):
  ...
  File: /mnt/c/Users/100kp/projects/AI-CIV/ECHO/to-corey/HANDOFF-2025-10-19-tg-bridge.md
```
...
python3 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/send_telegram_file.py \
  437939400 \
  /mnt/c/Users/100kp/projects/AI-CIV/ECHO/to-corey/HANDOFF-2025-10-19-tg-bridge.md \
