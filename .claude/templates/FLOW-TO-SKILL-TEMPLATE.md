...
version: 1.0.0
source: AI-CIV/ECHO (.claude/flows/[original-flow].md)
...
version: 1.0.0
source: AI-CIV/ECHO (.claude/flows/morning-consolidation.md)
...
See `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/skills-reference/morning-consolidation/SKILL.md` for a complete conversion example (when created).
