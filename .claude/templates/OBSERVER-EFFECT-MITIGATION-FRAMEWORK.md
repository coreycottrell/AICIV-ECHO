...
**See also**:
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/memory/agent-learnings/conflict-resolver/2025-10-14--pattern-observer-effect-in-evaluative-agents---documentation-changes-documented.md` (Full pattern analysis)
