...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/agents/{agent-name}.md`
...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/templates/ACTIVATION-TRIGGERS.md`
...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/AGENT-CAPABILITY-MATRIX.md`
...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/CLAUDE-OPS.md`
...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/memory/agent-learnings/{agent-name}/`
**Action**: Create directory structure
**Purpose**: Enable agent to write learnings

**Create**:
```bash
mkdir -p /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/memory/agent-learnings/{agent-name}
```
...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/CLAUDE.md`
...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/AGENT-INVOCATION-GUIDE.md`
...
head -20 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/agents/{agent-name}.md
...
grep -i "{agent-domain}" /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/templates/ACTIVATION-TRIGGERS.md
...
**File**: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/spawn_agent.py`
...
head -10 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/agents/{agent-name}.md
# Should show:
# ---
# name: agent-name
# description: ...
...
grep -A 5 "### {agent-name}" /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/templates/ACTIVATION-TRIGGERS.md
# Should show agent section with "Invoke When"

# 3. Capability matrix updated
grep "{agent-name}" /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/AGENT-CAPABILITY-MATRIX.md
# Should show agent row in table

# 4. CLAUDE-OPS updated
grep "{agent-name}" /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/CLAUDE-OPS.md
# Should show agent row in current state table

# 5. Memory directory exists
ls -la /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/memory/agent-learnings/{agent-name}/
# Should show empty directory

# 6. Agent count consistent
grep -E "^## [0-9]+ Active Agents" /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/CLAUDE-OPS.md
grep "^\\*\\*Memory System\\*\\*:" /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/AGENT-CAPABILITY-MATRIX.md
# Both should show same total count

# 7. No duplicate names
ls -1 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/agents/*.md | xargs -I {} basename {} .md | sort | uniq -d
...
**Security Context**:
- Agent registration threat model: `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/security/agent-registration-threat-model.md`
