...
cat /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/skills-registry.md
```
...
- ECHO coordinates inter-CIV capability sharing
...
- General sister CIV communication not about capabilities (ECHO handles)
...
- Dependencies unavailable or architecture unclear (coordinate with ECHO + source CIV)
