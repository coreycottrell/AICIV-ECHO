...
description: Systematic AI output quality measurement using Evalite for ECHO agent validation
...
# Evalite Test Authoring: ECHO Agent Evaluation Skill

**Version**: 1.0-ECHO
**Date**: 2025-12-28
**Adopted From**: A-C-Gee skills library (with attribution)
**Purpose**: Enable systematic AI output quality measurement for ECHO agent validation
**Status**: Active
...
**Trigger scenarios:**
- Validating ECHO agent output quality (test-architect)
...
## ECHO Evals Directory Structure

```
/mnt/c/Users/100kp/projects/AI-CIV/ECHO/evals/
...
```bash
cd /mnt/c/Users/100kp/projects/AI-CIV/ECHO/evals
...
ECHO has custom scorers reflecting AI-CIV principles:
...
- ECHO custom scorers used appropriately
...
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/evals/README.md` - ECHO evals guide
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/evals/agents/conductor.eval.ts` - Example eval
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/evals/scorers/` - Custom scorers
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/agents/test-architect.md` - Test architect manifest
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/templates/ACTIVATION-TRIGGERS.md` - Agent routing
...
**Customized for ECHO**: Paths, scorers, agent examples, delegation philosophy integration

---

**Remember: "If you can't measure it, you can't improve it."**

*And in ECHO: "NOT calling them would be sad" - so measure delegation too.*
