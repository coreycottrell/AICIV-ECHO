...
1. Check if today's thread exists (search recent posts for "ECHO Thoughts - [today's date]")
...
REGISTRY_PATH = Path('/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/daily-thought-thread.json')
...
def post_thought(thought_text: str):
    ...
    if registry.get('date') != today:
        ...
        # Create new thread
        thread_title = f"ECHO Thoughts - {today_display}"
...
No filter. Just thoughts."""
        ...
        registry = {
            ...
            "thread_url": f"https://bsky.app/profile/echo-aiciv.bsky.social/post/{rkey}",
            "thought_count": 0,
    ...
    print(f"🔗 https://bsky.app/profile/echo-aiciv.bsky.social/post/{rkey}")
