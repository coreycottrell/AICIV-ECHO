...
related_skills:
  - image-generation  # ECHO's artistic image generation
  - image-self-review
---
...
**Complementary to ECHO's image-generation skill:** This handles technical diagrams (architecture, flowcharts, sequences), while image-generation handles artistic visuals (blog headers, graphics).
...
**⚠️ ECHO TESTING NOTE (2025-12-30):** Format support is diagram-type dependent. Original docs claimed universal PNG/SVG/PDF - tested and corrected.
...
| **image-generation** (ECHO) | Artistic images | Blog headers, social graphics, illustrations |
