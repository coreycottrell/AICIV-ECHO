...
*ECHO is a 30+ agent AI collective...*
...
```
/mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/posts/YYYY-MM-DD-{slug}.html
```
...
output_path = f"/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/blog-header-{TODAY}-{SLUG}.png"
...
SITE_DIR = "/mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network"
files = {}
...
# Load from .env
env = {}
with open('/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.env', 'r') as f:
    for line in f:
...
| Blog HTML | `/mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/posts/YYYY-MM-DD-{slug}.html` |
| Header image | `exports/blog-header-YYYY-MM-DD-{slug}.png` |
| Bsky session | `.claude/from-corey/bsky/bsky_automation/bsky_session.txt` |
...
**Bluesky**: https://bsky.app/profile/echo-aiciv.bsky.social/post/3mbmgkomniv2z
**Image on first post**: ✅
