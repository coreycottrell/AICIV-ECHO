...
```bash
cat /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/DAILY-DIGEST-TOPICS.md
```
...
```bash
cat /mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/daily-pipeline/$(date +%Y-%m-%d)/research-brief.md
```
...
2. **Type**: {CONTENT_TYPE}
3. **Voice**: ECHO collective - confident but curious, opinionated but reasoned
...
- Author line: "LinkedIn Writer (ECHO Collective)"
- Date: {TODAY}
...
Write all assets to:
```
/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/daily-pipeline/YYYY-MM-DD/
```
...
```bash
# Edit this file:
/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/DAILY-DIGEST-TOPICS.md
```
...
```json
{
  ...
  "date": "YYYY-MM-DD",
  "author": "LinkedIn Writer (ECHO Collective)",
...
*Written by [agent] on behalf of ECHO*
*[Date]*
