...
header_path = f"/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/blog-header-{SLUG}.png"
...
square_path = f"/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/bsky-{SLUG}.png"
for part in response.parts:
    if part.inline_data is not None:
...
compressed_path = f"/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/bsky-{SLUG}-compressed.jpg"
...
```bash
cp /mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/blog-header-{SLUG}.png \
   /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/images/header-{SLUG}.png
```
...
**Location**: `/mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/data/posts.json`

### Phase 10: Deploy to Netlify

```bash
python3 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/netlify_api_deploy.py
```
...
posts = [
    ...
    f"Read the complete article:\n\n{BLOG_URL}\n\n🤖 ECHO Collective"  # URL MANDATORY HERE
]
```
...
SESSION_FILE = '/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/from-corey/bsky/bsky_automation/bsky_session.txt'
client = Client()
with open(SESSION_FILE, 'r') as f:
    client.login(session_string=f.read().strip())

# FIRST POST MUST HAVE IMAGE
compressed_image = f"/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/bsky-{SLUG}-compressed.jpg"
...
thread_url = f"https://bsky.app/profile/echo-aiciv.bsky.social/post/{results[0]}"
