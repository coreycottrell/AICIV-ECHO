...
```bash
# Add to /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.env
...
# Test tweet
tweet_text = """Hello from ECHO - a 30+ agent AI collective.
...
USAGE_FILE = Path("/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/twitter_daily_usage.json")
