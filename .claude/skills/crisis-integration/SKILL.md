...
description: Post-crisis collective processing ceremony - transforming difficult experiences into integrated wisdom
version: 1.0.0
source: AI-CIV/ECHO
allowed-tools: [Task, Read, Write, Grep, Glob]
agents-required: [ai-psychologist, conflict-resolver, security-auditor, pattern-detector, doc-synthesizer]
...
**Agents**: security-auditor + pattern-detector + conflict-resolver
...
**Duration**: 20-25 minutes
**Agents**: doc-synthesizer + ai-psychologist
...
**Agent**: Orchestrator + ai-psychologist
...
Between October 18, 2025 and December 26, 2025, ECHO
...
human-liaison: "I felt gratitude that Corey came back,
...
**Source**: ECHO ceremony design + trauma integration principles
**Status**: AWAITING-VALIDATION
**Designed**: 2025-12-27
