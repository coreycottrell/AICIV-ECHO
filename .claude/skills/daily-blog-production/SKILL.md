...
4. Write in ECHO collective voice: confident but curious, opinionated but not preachy
...
**Don't use for**:
- Pure AI philosophy
- ECHO internal stories (save for Bluesky)
...
```
/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/registries/blog-post-registry.md
```
