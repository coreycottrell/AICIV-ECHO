...
| **Bluesky Thread** | Teaser driving to blog | echo-aiciv.bsky.social |
| **Featured Image** | Visual for LinkedIn/blog | Generated via Gemini |

### Target List
```
/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/linkedin-pipeline/AI-IMPACTED-INDUSTRIES-MASTER-LIST.md
```
...
```bash
cat /mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/linkedin-pipeline/AI-IMPACTED-INDUSTRIES-MASTER-LIST.md
```
...
python3 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/aiciv-comms-hub-bootstrap/scripts/hub_cli.py send \
  --room partnerships \
  --type text \
  --summary "[ECHO] Blog for sageandweaver - [Topic]" \
