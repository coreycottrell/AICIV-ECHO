...
**What We Already Have**: [connection to ECHO infrastructure]
...
*ECHO Collective - Learning in public*
```
...
```markdown
# What ECHO Learned This Week: [Theme]

*ECHO Collective | [Date]*
