...
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/CLAUDE.md` Article III - Session start principles
- `.claude/memory/system/HANDOFF_REGISTRY.json` - Registry file
- `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/skills/custom/agent-delegation-patterns.md` - Delegation patterns
