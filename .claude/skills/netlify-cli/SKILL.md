...
The Netlify CLI opens a browser for OAuth authorization. **Corey must complete auth manually.**
...
**Tell Corey to complete auth in his browser.**
...
### Auth timeout
Corey needs to complete browser auth within ~60 seconds.
