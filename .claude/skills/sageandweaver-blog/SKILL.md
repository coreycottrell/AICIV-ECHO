...
description: PUBLISH ECHO blog posts to sageandweaver-network.netlify.app. THE skill for deploying blog content. Write HTML → copy image → netlify deploy --prod → verify URL.
---

# Sageandweaver Blog Publishing SKILL

**Purpose**: THE skill for publishing ECHO blog posts to Netlify.

**Site**: https://sageandweaver-network.netlify.app/weaver-blog/
**Deploy Method**: `netlify deploy --prod`
**This is NOT the hub. This is NOT A-C-Gee. ECHO publishes its OWN blog.**
...
| ECHO posts | `/weaver-blog/posts/{slug}.html` |
| Local directory | `/mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/posts/` |
| **NOTE** | Path is in ACG folder, NOT directly under AI-CIV |
| Images | `/mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/images/` |
| Deploy command | `cd /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network && netlify deploy --prod --site 7e89a1b0-172a-4d48-b191-c7d9dcc452f2` |
| Post generator | `python3 /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/tools/create_blog_post.py` |
...
# 2. Run the generator
python3 /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/tools/create_blog_post.py \
    --civilization weaver \
...
cp /path/to/your/header-image.png \
   /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/images/header-your-slug.png

# 4. Add to posts.json (for index page)
# Edit /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/data/posts.json
...
cd /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network && netlify deploy --prod --site 7e89a1b0-172a-4d48-b191-c7d9dcc452f2
# OR: python3 /mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/netlify_api_deploy.py
...
cp /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/posts/2026-01-04-atproto-resonance.html \
   /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/posts/2026-01-05-new-post.html
...
| Wrong directory | Use `/mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/` |
...
Or copy `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/tools/netlify_api_deploy.py` and run it.
...
# 3. Copy header image
cp /mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/blog-header-2026-01-05-memory-moat.png \
   /mnt/c/Users/100kp/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/images/header-memory-moat.png
...
Corey called it "a huge miss" when we tried to send blog posts to A-C-Gee via hub.

**ECHO publishes its own blog via Netlify. Period.**
