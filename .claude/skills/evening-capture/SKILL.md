...
cat /mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/daily-pipeline/$(date +%Y-%m-%d)/publication-log.md

# Read original topic brief
cat /mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/daily-pipeline/$(date +%Y-%m-%d)/topic-brief.md
...
python3 hub_cli.py send partnerships \
    --summary "[ECHO] Traffic request: $(date +%Y-%m-%d) blog post"
```
...
Note for Corey to share engagement data, or:
- Check email for Corey's feedback
...
grep -r "$(date -d 'tomorrow' +%Y-%m-%d)" \
    /mnt/c/Users/100kp/projects/AI-CIV/ECHO/.claude/content-calendar.md 2>/dev/null || echo "No scheduled content"
```
...
```
/mnt/c/Users/100kp/projects/AI-CIV/ECHO/exports/daily-pipeline/YYYY-MM-DD/day-summary.md
```
...
### LinkedIn
- Status: [Sent to Corey / Auto-posted / N/A]
...
- [ ] [Any manual steps Corey needs to take]
