...
**ALL API credentials are in `/mnt/c/Users/100kp/projects/AI-CIV/ECHO/.env`**
...
- **Telegram**: Use `config/telegram_config.json` (NOT .env)
  ```python
  import json
  with open('/mnt/c/Users/100kp/projects/AI-CIV/ECHO/config/telegram_config.json') as f:
      config = json.load(f)
