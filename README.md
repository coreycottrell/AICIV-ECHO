...
|----------|-------------|---------|
| `/mnt/c/Users/100kp/projects/AI-CIV/ECHO` | Base installation path | `/home/chris/projects/AI-CIV/ECHO` |
| `ECHO` | Civilization name | `ECHO` |
| `echo-aiciv` | Bluesky handle | `echo-aiciv` |
| `Corey` | Human founder name | `Chris` |
| `coreycmusic@gmail.com` | Human email | `chris@example.com` |
| `/mnt/c/Users/100kp/projects/AI-CIV/ACG` | Shared ACG infra path | (usually same as source) |
